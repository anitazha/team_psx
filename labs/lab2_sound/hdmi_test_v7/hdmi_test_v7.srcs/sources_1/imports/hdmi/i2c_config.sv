typedef enum reg [5:0] {  STB_CYC, CORE,

			  /* switch configuration states */
			  SWITCH_RESET, SWITCH_INIT_W1, SWITCH_WAIT_W1,
			  SWITCH_TIP_W1, SWITCH_ACK_W1, SWITCH_INIT_W2,
			  SWITCH_WAIT_W2, SWITCH_TIP_W2, SWITCH_ACK_W2,
			  CHECK_INIT, CHECK_WAIT, CHECK_TIP, CHECK_ACK,
			  CHECK_READ_1, CHECK_READ_2,

			  /* Hot Plug Detect states */
			  CHECK_HPD_SI_1, CHECK_HPD_SW_1, CHECK_HPD_ST_1,
			  CHECK_HPD_SA_1, CHECK_HPD_AI, CHECK_HPD_AW,
			  CHECK_HPD_AT, CHECK_HPD_AA, CHECK_HPD_SI_2,
			  CHECK_HPD_SW_2, CHECK_HPD_ST_2, CHECK_HPD_SA_2,
			  CHECK_HPD_READ_1, CHECK_HPD_READ_2,
			  
			  /* ADV7511 configuration states */
			  SLAVE_INIT, SLAVE_WAIT, SLAVE_TIP, SLAVE_ACK,
			  ADDR_INIT, ADDR_WAIT, ADDR_TIP, ADDR_ACK,
			  DATA_INIT, DATA_WAIT, DATA_TIP, DATA_ACK,
			  CHECK_HDMI_SI_1, CHECK_HDMI_SW_1, CHECK_HDMI_ST_1,
			  CHECK_HDMI_SA_1, CHECK_HDMI_AI, CHECK_HDMI_AW,
			  CHECK_HDMI_AT, CHECK_HDMI_AA, CHECK_HDMI_SI_2,
			  CHECK_HDMI_SW_2, CHECK_HDMI_ST_2, CHECK_HDMI_SA_2,
			  CHECK_HDMI_READ_1, CHECK_HDMI_READ_2,

			  SWITCH_VERIFY, HDMI_VERIFY, HPD_VERIFY,
			  ERROR, IDLE } iic_fsm_t;
